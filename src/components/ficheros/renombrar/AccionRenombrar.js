...
export default function AccionRenombrar ({ pais, listDatsalDatent, onChangePrefijoSufijo, textareaOrigenValue, setTextareaOrigenValue, textareaDestinoValue, setTextareaDestinoValue }) {
